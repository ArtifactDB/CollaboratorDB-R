...
**CollaboratorDB** provides an ExperimentHub-like data store for Bioconductor objects based on the [schemas here](https://github.com/ArtifactDB/CollaboratorDB-schemas).
...
If you're not on the [list](https://github.com/ArtifactDB/CollaboratorDB-worker/master/tree/wrangler.toml), you'll have to ask someone to create a stub project for you before you can use `uploadDirectory()`.
🚨🚨🚨
